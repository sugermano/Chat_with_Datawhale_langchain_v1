...
class QA_chain_self():
    ...
    def __init__(self, model:str, temperature:float=0.0, top_k:int=4,  file_path:str=None, persist_path:str=None, appid:str=None, api_key:str=None, Spark_api_secret:str=None,Wenxin_secret_key:str=None, embedding = "openai",  embedding_key = None, template=default_template_rq):
        ...
        #     | StrOutputParser()
        # )
        # combine_docs_chain = create_stuff_documents_chain(self.llm, self.QA_CHAIN_PROMPT)
    ...
    def answer(self, question:str=None, temperature = None, top_k = 4):
        ...
        result = self.qa_chain.invoke(input={"question": question, "temperature": temperature, "top_k": top_k, 'chat_history': []})
        # qa.invoke(input={"question": question,"chat_history": self.chat_history})   
