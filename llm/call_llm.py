...
def get_completion_glm(prompt : str, model : str, temperature : float, api_key:str, max_tokens : int):
    ...
    # print('问答response', response.choices[0].message.content)
...
#     text.append(jsoncon)
#     return text
# 1 validation error for ZhipuAILLM
# client
#   Field required [type=missing, input_value={'model': 'chatglm_std', ...y', 'temperature': 0.01}, input_type=dict]
